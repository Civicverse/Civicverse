...
StarterNode/ ├── backend/ │ ├── app.py # FastAPI backend API server │ ├── governance.py # Simple voting logic & in-memory storage │ ├── fryboy_test.py # AI Ethics & Fryboy Test heuristics │ ├── mining.py # Minimal community mining reward logic │ └── identity.py # Basic identity verification ├── frontend/ │ ├── public/ │ ├── src/ │ │ ├── App.jsx # Main React UI │ │ ├── Mining.jsx # Mining dashboard │ │ └── Voting.jsx # Voting interface ├── README.md # This file ├── requirements.txt # Backend Python dependencies ├── package.json # Frontend Node dependencies └── docker-compose.yml # Optional multi-container setup
